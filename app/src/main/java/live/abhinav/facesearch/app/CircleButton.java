...
/**
 * Created by Abhinav on 10/24/2014.
 */
...
public class CircleButton extends ImageView
{
    ...
    private int defaultColor1 = Color.argb(255,51,181,229);
    ...
    protected void onDraw(Canvas canvas) {
        canvas.drawCircle(centerX, centerY, pressedRingRadius + animationProgress+4, focusPaint);
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        pressedRingRadius = outerRadius - pressedRingWidth - pressedRingWidth/9 ;
    }
    ...
    public void setColor(int color) {
        ...
        focusPaint.setColor(defaultColor1);
